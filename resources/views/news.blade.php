...
<div class="container-fluid header-bg py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <h1 class="display-4 text-white mb-3 animated slideInDown">{{__('trans.News')}}</h1>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5 mb-1 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="{{route('articleDetails',$lang)}}">
                            <div class="position-relative">
                                <img class="img-fluid" src="{{asset('assets/img/article-2.jpg')}}" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">{{__('trans.category')}}</p>
                                    <h5 class="text-white mb-0">{{__('trans.article title')}}</h5>
                                </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="{{route('articleDetails',$lang)}}">
                            <div class="position-relative">
                                <img class="img-fluid" src="{{asset('assets/img/article-3.jpg')}}" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">{{__('trans.category')}}</p>
                                    <h5 class="text-white mb-0">{{__('trans.article title')}}</h5>
                                </div>
