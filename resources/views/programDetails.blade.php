...
@section('content')
 ...
 <div class="container-fluid header-bg py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-4 text-white mb-3 animated slideInDown">{{__('trans.Program Details')}}</h1>
    ...
    <div class="container pt-2 pb-3">
        <div class="row">
            ...
            <div class="col-lg-4 col-12 p-4">
                <h4 class="text-uppercase text-center mb-4">{{__('trans.other programs')}}</h4>
